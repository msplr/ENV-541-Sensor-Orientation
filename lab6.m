...
fprintf('Sensor norm:\n');
fprintf('gyro: %.7e rad/s, difference to w_ref %.3e rad/s (%.4f%%)\n', ...
    gyro_norm, gyro_norm-w_ref, 100*(gyro_norm-w_ref)/w_ref);
fprintf('accel: %.7e m/s^2, difference to g_EPFL %.3e m/s^2 (%.4f%%)\n', ...
    accel_norm, accel_norm-g_EPFL, 100*(accel_norm-g_EPFL)/g_EPFL);
